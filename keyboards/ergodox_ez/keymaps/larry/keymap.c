...
[_QWERTY] = LAYOUT_ergodox(
    ...
    KC_LSFT, KC_Z,   KC_X,   KC_C,     KC_V,   KC_B, WTF,
    ______,    ______, ______, KC_GRAVE, KC_EQUAL,
                   KC_LGUI,   KC_LALT,
                              OMG,
        KC_BSPC, KC_ESCAPE, KC_LCTL,

    ______,   KC_6, KC_7,   KC_8,     KC_9,   KC_0,      ______,
    KC_QUOTE, KC_Y, KC_U,   KC_I,     KC_O,   KC_P,      ______,
              KC_H, KC_J,   KC_K,     KC_L,   KC_SCLN, KC_QUOTE,
    OMG,      KC_N, KC_M,   KC_COMMA, KC_DOT, KC_SLSH,  KC_RSFT,
                     KC_MINUS, KC_BSLS,   ______, ______,    ______,
        KC_RALT,  KC_RGUI,
        WTF,
...
[_WTF] = LAYOUT_ergodox(
    ...
    ______, ______, ______, ______,        ______,
                   ______, ______,
                           ______,
        KC_DELETE, ______, ______,

    ______, ______, ______,              ______,               ______,      ______,      ______,
    ______, ______, ______,              ______,               ______,      ______,      ______,
            ______, KC_LEFT_CURLY_BRACE, KC_RIGHT_CURLY_BRACE, KC_LBRC, KC_RBRC, ______,
    ______, ______, ______,              ______,               ______,      ______,      ______,
                    ______,              ______,               ______,      ______,      ______,
        ______, ______,
        ______,
